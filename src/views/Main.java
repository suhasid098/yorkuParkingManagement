...
public class Main extends JFrame {
	...
	public Main() {
		...
		int space = 20;
		optionsPane.add(Box.createVerticalGlue()); // Makes components keep with the top of the pane. Used in centering
		...
		optionsPane.add(Box.createVerticalGlue()); // Makes components keep with the bottom of the pane. Used in
