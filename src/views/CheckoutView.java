...
public class CheckoutView extends JFrame {
	...
	public CheckoutView(Main frame) {
		...
		bmoButton.setFont(new Font("Tahoma", Font.PLAIN, 6));
		bmoButton.setVisible(false);

		JButton cibcButton = new JButton("CIBC");
		cibcButton.setFont(new Font("Tahoma", Font.PLAIN, 6));
		cibcButton.setVisible(false);

		JButton rbcButton = new JButton("RBC");
		rbcButton.setFont(new Font("Tahoma", Font.PLAIN, 6));
		rbcButton.setVisible(false);

		JButton scotiabankButton = new JButton("SB");
		scotiabankButton.setFont(new Font("Tahoma", Font.PLAIN, 6));
		scotiabankButton.setVisible(false);

		JButton tdButton = new JButton("TD");
		tdButton.setFont(new Font("Tahoma", Font.PLAIN, 6));
